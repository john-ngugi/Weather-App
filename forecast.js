...
*/
const condition = document.querySelector('.condition-now');
...
*/
            ...
            const iconId = data.forecast.forecastday[0].day.condition.icon.substr("//cdn.weather.com/weather/64x64/".length);
            const iconId1 = data.forecast.forecastday[1].day.condition.icon.substr("//cdn.weather.com/weather/64x64/".length);
            const iconId2 = data.forecast.forecastday[2].day.condition.icon.substr("//cdn.weather.com/weather/64x64/".length);
